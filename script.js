const questions = [
    ...
    {
        question: "Who is the best fielder in the world?",
        answers:[
        { text:"Virat Kohli",correct:false},
        { text:"Ravindra Jadeza",correct:true},
        { text:"Glenn Phillips",correct:false},
        { text:"David Warner",correct:false},
        ]
    },
    {question: "Who is the best allrounder in the world?",
        answers:[
        { text:"Hardik Pandya",correct:false},
        { text:"Ravindra Jadeza",correct:false},
        { text:"Ben Stokes",correct:true},
